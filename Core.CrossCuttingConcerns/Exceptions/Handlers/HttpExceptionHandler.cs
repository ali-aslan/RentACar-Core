...
namespace Core.CrossCuttingConcerns.Exceptions.Handlers
{
    public class HttpExceptionHandler : ExceptionHandler
    {
        ...
        protected override Task HandleException(BusinessException businessExceptions)
        {
        ...
        protected override Task HandleException(Exception businessExceptions)
        {
            Response.StatusCode = StatusCodes.Status500InternalServerError;
            string details = new InternalServerProblemDetails(businessExceptions.Message).AsJson();
            return Response.WriteAsync(details);
        }
